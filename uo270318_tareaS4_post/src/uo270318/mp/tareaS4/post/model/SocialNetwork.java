...
public class SocialNetwork {
    ...
    /**
     * Metodo que permite formatear los post
     * 
     * @return postHTML lista con los post formateados
     */
    public ArrayList<String> htmlFormat() {
	ArrayList<String> postHTML = new ArrayList<String>();
	for (Post post : posts) {
	    postHTML.add(post.postHTML());
	}
	return postHTML;
    }
