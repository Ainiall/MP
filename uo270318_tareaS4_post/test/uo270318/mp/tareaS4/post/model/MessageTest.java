 ...
 * Message.java {@link uo270318.mp.tareaS4.post.model.Message}
 * </p>
 * <p>
...
public class MessageTest {
     ...
     * {@link uo270318.mp.tareaS4.post.model.Message#Message(String userID, String message)}.
     */
    @Test
    ...
    /**
     * Metodo Test que hace referencia a
     * {@link uo270318.mp.tareaS4.post.model.Message#setMessage(String message)}.
     */
    @Test
    ...
    /**
     * Metodo Test que hace referencia a
     * {@link uo270318.mp.tareaS4.post.model.Message#getMessage()}.
     */
    @Test
	...
	assertEquals("UserID: Angela" + "\nNumber of likes: 0"
		+ "\nMessage: Hola, Mundo!", msg.toString());
    }
