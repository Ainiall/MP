 ...
 * SocialNetwork.java {@link uo270318.mp.tareaS4.post.model.SocialNetwork}
 * </p>
 * <p>
...
public class SocialNetworkTest {
     ...
     * {@link uo270318.mp.tareaS4.post.model.SocialNetwork#add(Post post)}.
     */
    @Test
    public void testAdd() {
	// Inserto valido
    ...
    /**
     * Metodo Test que hace referencia a
     * {@link uo270318.mp.tareaS4.post.model.SocialNetwork#printPost(PrintStream out)}.
     */
    @Test
    ...
    /**
     * Metodo Test que hace referencia a
     * {@link uo270318.mp.tareaS4.post.model.SocialNetwork#userPosts(String userID)}.
     */
    @Test
	...
	assertEquals(
		"[<p>msg1</p>, <img src=path1>title1</img>, <p>msg2</p>, <img src=path2>title2</img>]",
		sn.htmlFormat().toString());
    }
}
