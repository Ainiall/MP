...
import uo.mp.sort.BySalesComparator;
...
public class UserInterface {
    ...
    //comparable se utiliza cuando se quiere usar un orden natural (ascendiente o descendiente)
    
    //con varios criterios se usa comparator
    
  
    private void sortByName() {
	Collections.sort(newStand.getPublications());
	listPublication(newStand.getPublications());
    }
    
    private void sortBySales() {
	Collections.sort(newStand.getPublications(),new BySalesComparator());
	listPublication(newStand.getPublications());
